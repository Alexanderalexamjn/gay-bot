...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~XFdE3R6a#YXNwq1KTMToQReFNua19q6EPCzVwLq9deX65g8zp4iU",
  MENU_URL: process.env.MENU_URL || "https://cdn.ironman.my.id/i/xcg418.jpg",
  CAPTION: process.env.CAPTION || "Made with 🤍",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "gay fasweeh",
  BOT_NAME: process.env.BOT_NAME || "Iᴢᴜᴍɪ-ᴍᴅ",
  SUDO: process.env.SUDO || "2348060585869,918590822912,917025099154
